...
def Menu():
    BG = pygame.image.load("Assets\\GUI\\Menu background.png")
    screen = pygame.display.set_mode((1000, 600))

    def get_font(size): # Returns Press-Start-2P in the desired size
        return pygame.font.Font("Assets\\Font/BAUHS93.TTF", size)
    def main_menu():
        while True:
            screen.blit(BG, (0, 0))
            ...
            Easy_BUTTON = Button(image=pygame.image.load("Assets\\GUI\\Play Rect.png"), pos=(500, 250), 
                            text_input="Easy",font=get_font(75), base_color="#d7fcd4", hovering_color="White")
            Hard_BUTTON = Button(image=pygame.image.load("Assets\\GUI\\Quit Rect.png"), pos=(500, 400), 
